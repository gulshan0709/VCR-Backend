                            ...
                            <tbody>
                                 ...
                                 success: function(data){
                                     for (var i=0; i<data.length; i++) {
                                        var row = '<tr><td>' + data[i].id+ '</td><td>' + data[i].cname +'</td><td>'+"<button class='btn btn-danger' onclick='destroy("+data[i].id+")'>Delete </button>"+ " <a href='/editcourse/"+data[i].id+"'> <button class='edit btn btn-sm btn-black'> Edit </button></a>"+'</td></tr>'
...
<script>
    function destroy(e) {
       ...
       $.ajax({
           url: "http://localhost:8000/api/course/"+e,
