                            ...
                            <tbody>
                                 ...
                                 success: function(data){
                                     for (var i=0; i<data.length; i++) {
                                        var row = '<tr><td>' + data[i].id+ '</td><td>' + data[i].first_name + '</td><td>' + data[i].last_name + '</td><td>' + data[i].address+ '</td><td>' + data[i].phone+ '</td><td>' + data[i].email+ '</td><td>'+"<button class='btn btn-danger' onclick='destroy("+data[i].id+")'>Delete </button>"+ " <a href='/editstudent/"+data[i].id+"'><button class='edit btn btn-sm btn-black'> Edit </button></a>"+'</td></tr>'
                                         $('#list').append(row);
                                     }
                                 },
...
<script>
    function destroy(e) {
       ...
       $.ajax({
           url: "http://localhost:8000/api/student/"+e,
